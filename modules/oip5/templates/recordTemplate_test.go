...
func TestDecodeRecordTemplate(t *testing.T) {
	...
	rt := &templates.RecordTemplate{Txid: "8910cbc1923e6b64d4012b88b85703237630bab2083410a74fa1ff8e7ffca439"}
	err = templates.DecodeDescriptorSet(rt, o5.RecordTemplate.DescriptorSetProto)
	if err != nil {
		t.Fatal(err)
	}
...
func TestNotStringProtobufJs(t *testing.T) {
	...
	rt := &templates.RecordTemplate{Txid: "deadbeef"}
	err := templates.DecodeDescriptorSet(rt, descriptor)
	if err != nil {
		t.Fatal(err)
	}
...
func TestCreateTemplate(t *testing.T) {
	pDso := []byte{
		,
	}

	rt := &pb_templates.RecordTemplateProto{
		FriendlyName:       "Payments",
		Description:        "Basic terms of content for purchase",
		DescriptorSetProto: pDso,
		Extends:            nil,
		Identifier:         0,
	}
...
func TestEditTemplate(t *testing.T) {
	pDso := []byte{
		,
	}
	...
	edit := &pb_oip5.EditProto{
		Reference: pb_oip.TxidFromString("6e6d471d434b5ed2441aac7e040b898ae75f98a33f5a5b8189743cba849bc47e"),
		Mod: &pb_oip5.EditProto_Template{
			Template: &pb_templates.RecordTemplateProto{
				FriendlyName:       "Options",
				Description:        "A simple text field and option picker",
				DescriptorSetProto: pDso,
			},
		},
	}
